...
class ClientNotificationsDenniedAdapter(
    val notifications: List<ClientNotification>,
    val context: Context
) : RecyclerView.Adapter<ClientNotificationsDenniedAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val viewDennied = LayoutInflater.from(context)
            .inflate(R.layout.prototype_client_notification_rejected, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        picBuilder.build().load(notification.client.photo).placeholder(R.color.white)
            .error(R.color.white).into(holder.iv_client_notification_reject_profile)
