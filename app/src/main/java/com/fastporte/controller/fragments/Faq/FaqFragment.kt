...
class FaqFragment : Fragment() {
    ...
    private fun loadData(view: View) {
        ...
        faqList = listOf(
            Faq("¿Cómo solicito un servicio de transporte en la aplicación?",
            ...
            Faq("¿Cómo puedo pagar por el servicio de transporte?",
            ...
            Faq("¿Qué sucede si un conductor rechaza mi solicitud de transporte?",
            ...
            Faq("¿Cómo puedo rastrear el progreso de mi transporte?",
            ...
            Faq("¿Qué sucede si un conductor no cumple con el servicio solicitado?",
            ...
            Faq("¿Puedo dejar comentarios sobre el conductor después de completar el servicio?",
            ...
            Faq("¿Puedo programar un servicio de transporte para una fecha y hora específicas?",
            ...
            Faq("¿Puedo cancelar mi solicitud de transporte después de haberla confirmado?",
            ...
            Faq("¿Cómo puedo contactar directamente al conductor?",
            ...
            Faq("¿Qué medidas de seguridad se toman para proteger mi información personal y financiera?",
